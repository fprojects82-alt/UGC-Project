...
| Token       | HSL              | Use                         |
| ----------- | ---------------- | --------------------------- |
| primary     | 252 83% 60%      | Indigo/violet — tech, CTAs  |
| accent      | 38 78% 60%       | Warm gold — luxury, metrics |
| background  | 240 24% 6%       | Near-black navy (dark)      |
| foreground  | 240 20% 96%      | Text on dark                |

## Typography

- Display / Latin: **Space Grotesk** (`--font-display`)
- Body / Latin: **Inter** (`--font-sans`)
- Arabic (all weights, first-class): **IBM Plex Sans Arabic** (`--font-arabic`)

Arabic is loaded at the same scale/weight prominence as Latin — never a fallback.
